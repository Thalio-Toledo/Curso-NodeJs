...
router.get('/categorias/teste', eAdmin, (req,res)=>{
    res.render('admin/teste',{nome:""})
})
...
router.post('/categorias/deletar',eAdmin, (req,res)=>{
    Categoria.remove({id:req.body.id}).then(()=>{
...
router.post("/postagens/nova", eAdmin,(req,res)=>{
    ...
    if(erros.length > 0 ){
        ...
        new Postagem(novaPostagem).save().then(()=>{
            ...
            req.flash("error_msg","Houve em erro durante o salvamento da postagem")
            res.redirect("/admin/postagens")
        })
    }
})
